...
**OpenAPI** Full documentation in [api.agrospace.cl](api.agrospace.cl/doc)
...
Please note that this project is released with a [Contributor Code of Conduct](https://api.agrospace.cl). By participating in this project you agree to abide by its terms.
